...
USE PV_521_Import;
SET DATEFIRST 1; --Для правильной интерпретации дней недели (понедельник первый)
...
BEGIN
		...
		DECLARE @day	AS	TINYINT = DATEPART(WEEKDAY, @date); --DATEPART - Возвращает текущий день недели в виде числа
